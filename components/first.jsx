export default function First() {
  return (
    <div className="flex flex-col md:flex-row items-center bg-[#FFF1ED] p-11 md:p-12 rounded-lg shadow-lg space-y-6 md:space-y-0 font-sans">
      ...
      <div className="text-center md:text-left space-y-4 md:w-1/2">
        ...
        <p className="text-gray-600 text-[24px]">
          Ordena lo que te gusta en pocos pasos y disfruta de <br></br>tu comida sin esperar.
        </p>
