...
export default function First() {
  ...
  return (
    <section className=" lg:bg-[#FFF1ED] lg:py-24 lg:flex lg:justify-center md:flex md:justify-center sm:flex sm:justify-center sm:p-4">
      {/* Contenedor exterior que extiende el fondo */}

      <div className=" sm:max-w-96 md:max-w-3xl  md:px-24 lg:flex lg:justify-evenly  lg:items-center lg:max-w-7xl lg:px-[20px] ">
        <div className=" lg:flex lg:flex-col ">
          {/**Title and subtittle */}
          <div className=" sm:mb-8 sm:gap-4 text-black   flex flex-col md:mt-8 md:text-center sm:text-center lg:text-left lg:gap-4  lg:mb-12 ">
            <h1 className="  sm:text-3xl font-bold font-roboto  md:text-5xl md:font-poppins lg:text-[64px] lg:font-roboto">
